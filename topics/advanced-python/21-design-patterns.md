# Модуль 21: Паттерны проектирования в Python

> **Примечание:** паттерн Singleton подробно разобран в [модуле 09](09-singletons.md). Здесь — краткое напоминание и остальные паттерны.

## Метаданные

| Параметр | Значение |
|----------|----------|
| Предварительные знания | ООП (модули [01–08](01-oop-classes-objects.md)), [TypeVar](19-mutations-typevar.md), [Протоколы](20-protocols.md); базовый [async](13-threads-async-coroutines.md) для Observer |
| Предыдущий модуль | [20-protocols.md](20-protocols.md) |
| Следующий модуль | [22-big-o.md](22-big-o.md) |
