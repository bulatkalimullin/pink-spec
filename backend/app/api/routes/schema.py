...
async def get_spec_levels():
    return {
        "levels": [
            ...
            {"id": "L2", "name": "Standard", "time": "10–15 min", "description": "Core specs + 15–30 tasks"},
            {"id": "L3", "name": "Full", "time": "20–30 min", "description": "All artifacts + 50–100 tasks"},
            {"id": "L4", "name": "Exhaustive", "time": "Until approved", "description": "Deep-dive, iterative refinement"},
        ]
    }
